...
@section('title', isset($blog) ? 'Edit Post - ClickVerse' : 'Create Post - ClickVerse')
...
<div class="content-header">
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ isset($blog) ? 'Edit Post' : 'Create Post' }}</h1>
            </div>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ isset($blog) ? 'Edit Post' : 'Create Post' }}</li>
                </ol>
            </div>
        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label">
                                                {{ isset($blog) && $blog->feature_image ? $blog->feature_image : 'Choose file' }}
                                            </label>
                                        </div>
                                            ...
                                            @foreach ($tags as $tag)
                                                <div class="custom-control custom-checkbox mr-3">
                                                    <input class="custom-control-input" type="checkbox"
                                                           ...
                                                           value="{{ $tag->id }}"
                                                           {{ (is_array(old('tags', isset($blog) ? $blog->tags->pluck('id')->toArray() : []))
                                                               && in_array($tag->id, old('tags', isset($blog) ? $blog->tags->pluck('id')->toArray() : []))) ? 'checked' : '' }}>
