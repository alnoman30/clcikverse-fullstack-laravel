                ...
                <div class="bricks-wrapper h-group">
                    ...
                    @foreach ($blogs as $blog){
                        ...
                        <div class="entry__thumb">
                            <a href="{{ route('blog.singleblog', $blog->slug) }}" class="thumb-link">
                                <img src="{{ asset('uploads/blogs/' . $blog->feature_image) }}"
                                     srcset="{{ asset('uploads/blogs/' . $blog->feature_image) }} 1x, {{ asset('uploads/blogs/' . $blog->feature_image) }} 2x" alt="">
                            </a>
                        </div> <!-- end entry__thumb -->

                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="{{ route('blog.singleblog', $blog->slug) }}">{{ $blog->title }}</a></h1>

                                <div class="entry__meta">
                                    <span class="byline"">By:
                                        <span class='author'>
                                            <a href="https://alnoman.vercel.app">{{ $blog->user->name }}</a>
                                    </span>
                                </span>
                                    <span class="cat-links">
                            ...
                            <a class="entry__more-link" href="{{ route('blog.singleblog', $blog->slug) }}">Learn More</a>
                        </div> <!-- end entry__text -->
