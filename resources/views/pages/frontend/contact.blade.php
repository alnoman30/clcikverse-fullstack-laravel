            ...
            <div class="column large-12">
                ...
                <article class="s-content__entry">
                    ...
                    <div class="s-content__media">
                        <img src="{{ asset('assets/frontend/images/thumbs/contact/contact-1050.jpg') }}"
                                srcset="{{ asset('assets/frontend/images/thumbs/contact/contact-2100.jpg') }} 2100w,
                                        {{ asset('assets/frontend/images/thumbs/contact/contact-1050.jpg') }} 1050w,
                                        {{ asset('assets/frontend/images/thumbs/contact/contact-525.jpg') }} 525w" sizes="(max-width: 2100px) 100vw, 2100px" alt="">
